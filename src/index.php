  ...
  <div class="w-full h-auto min-h-screen flex justify-center items-center">
    <form action="postedData.php" method="POST">
      <div class="shadow-xl bg-[#4F6F52] w-96 max-w-2xl h-auto p-7 flex flex-col gap-3 rounded-2xl">
        ...
        <?php if (isset($_SESSION['hasNameErr']) && $_SESSION['hasNameErr'] == 1) : ?> <span class="text-red-400 -mt-2">ورود نام الزامیست.</span> <?php endif; ?>
        <div class="flex flex-col gap-3">
        ...
        <?php if (isset($_SESSION['hasLastNameErr']) && $_SESSION['hasLastNameErr'] == 1) : ?> <span class="text-red-400 -mt-2">ورود نام خانوادگی الزامیست.</span> <?php endif; ?>
        <div class="flex flex-col gap-3">
        ...
        <?php if (isset($_SESSION['hasAgeErr']) && $_SESSION['hasAgeErr'] == 1) : ?> <span class="text-red-400 -mt-2">ورود سن الزامیست.</span> <?php endif; ?>
        <div class="flex flex-col gap-3">
        ...
        <?php if (isset($_SESSION['hasEmailErr']) && $_SESSION['hasEmailErr'] == 1) : ?> <span class="text-red-400 -mt-2">ورود ایمیل الزامیست.</span> <?php endif; ?>
        <div class="flex flex-col gap-3">
        ...
        <?php if (isset($_SESSION['hasPassErr']) && $_SESSION['hasPassErr'] == 1) : ?>
          <span class="text-red-400 -mt-2">ورود رمز عبور الزامیست.</span>
        <?php endif; ?>
        <?php if (isset($_SESSION['invalidPass']) && $_SESSION['invalidPass'] == 1 &&  $_SESSION['hasPassErr'] == 0) : ?>
          <span class="text-red-400 -mt-2">رمز عبور انتخابی باید حداقل دارای یک حرف بزرگ یک حرف کوچک و یک عدد باشد.</span>
        <?php endif; ?>
        <div class="flex flex-col gap-3">
